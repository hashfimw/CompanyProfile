    ...
    <div className="container py-16 px-5 mx-auto ">
      ...
      >
        <h1 className="text-4xl font-bold text-[#2F3546] mb-6">
          About Palse Advertising
        </h1>
        <p className="text-lg text-[#2F3546] mb-8">
          Palse Advertising is a leading digital marketing agency that
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          variants={textVariants}>
            ...
            <ul className="text-lg text-[#2F3546] text-center space-y-2">
        ...
        <div className="mt-12">
          <h2 className="text-4xl font-semibold text-[#2F3546] mb-6 text-center">
            Why Choose Us?
          </h2>
          <p className="text-lg text-[#2F3546]">
            At Palse Advertising, we combine creativity with data-driven
            ...
            relationships and delivering measurable results, Palse Advertising
